...
@section('content')
    ...
    <div class="section mt-2" id="presence-section">
        ...
        <div id="rekappresensi">
            <h1 style="font-size: 1.1rem;">Rekap Absen bulan {{ $namabulan[$bulanini] }} tahun {{ $tahunini }}</h1>
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            <span class="badge bg-danger"
                                style="position:absolute; top: 6px; right: 10px; font-size: 0.7rem;
                        z-index: 999;">{{ $rekappresensi->jmlhadir }}</span>
                            <ion-icon name="hand-right-outline" style="font-size: 1.5rem;"
                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        z-index: 999;">{{ $rekapizin->jmlsakit }}</span>
                            <ion-icon name="medkit-outline" style="font-size: 1.5rem;"
